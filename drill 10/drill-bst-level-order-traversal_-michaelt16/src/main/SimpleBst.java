...
public interface SimpleBst<T extends Comparable<T>> {
  ...
  /**
   * Returns a level-order iterator over the elements in the BST.
   *
   * @return a level-order iterator over the elements in the BST
   */
  Iterator<T> levelOrderIterator();

  /**
   * Don't worry about implementing this for this drill! Just stub it out.
   *
   * @param t nope
   */
  void remove(T t);
